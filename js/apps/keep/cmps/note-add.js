  ...
  <section class="note-add flex column gap">
    <div class="box-note-add flex column gap align-center " @keyup.enter="addNewNote">
        <div class = "search-box flex align-center" >
          <button  @click="addNewNote" class="btn btn-icon" ><ion-icon name="add-outline" /></button>
        ...
        <div class="note-types-box flex gap align-center ">
			...
			<button @click="setTypeNote('text')"  class="btn btn-icon"><ion-icon name="text-outline"/></button>
			<button  @click="todo" class="btn btn-icon"><ion-icon name="list-outline" /></button>
			<button  @click="setTypeNote('img')" class="btn btn-icon"><ion-icon name="image-outline"/></button>
        </div>
    </div>
  </section>`,
  data() {

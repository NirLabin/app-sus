...
export default {
	template: `
        <section class="keep-app">
              ...
              <note-list  v-if="!filterdNotes.length" :notes="pinnedNotes" @remove="deleteNote" @pin="pinNote" @color="changeColor"></note-list>
              <note-list v-if="!filterdNotes.length" :notes="unPinnedNotes" @remove="deleteNote" @pin="pinNote" @color="changeColor"></note-list>
        </section>

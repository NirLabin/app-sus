  ...
  template: `
        <header class="app-header flex space-between align-center">
            ...
            <div class="main-app-menu-container flex align-center gap">
              <button class="btn btn-main-menu flex align-center vivify spin " @click="toggleApps" :class="{active:menuOpen}"><ion-icon name="apps-outline"></ion-icon></button>
              <nav class="main-app-menu flex align-center" @click="toggleApps" v-if="menuOpen">
                  ...
                  <router-link to="/email" active-class="active"><img class="menu-img"src="https://play-lh.googleusercontent.com/KSuaRLiI_FlDP8cM4MzJ23ml3og5Hxb9AapaGTMZ2GgR103mvJ3AAnoOFz1yheeQBBI" alt=""></router-link> 
